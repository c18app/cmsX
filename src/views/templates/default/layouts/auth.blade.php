...
<head>
    ...
    @if(App::environment('local'))
        ...
        <link rel="stylesheet" href="/vendor/c18app/cmsx/css/auth/app.css?v={{ time() }}">
        <script src="/vendor/c18app/cmsx/js/auth/app.js?v={{ time() }}"></script>
    @else
        <title>Admin</title>
        ...
        <link rel="stylesheet" href="/vendor/c18app/cmsx/css/auth/app.css?v={{ config('cmsx.version') }}">
        <script src="/vendor/c18app/cmsx/js/auth/app.js?v={{ config('cmsx.version') }}"></script>
    @endif
</head>
<body class="auth">
<div class="container">
